...
public class GTSWItems {
    ...
    // 筛网
    // 钢筛网
    public static final ItemEntry<ComponentItem> STEEL_SIEVE_NET = REGISTRATE
            .item("steel_sieve_net", ComponentItem::create)
            .lang("Steel Sieve Net")
            .register();

    // 铝筛网
    public static final ItemEntry<ComponentItem> ALUMINIUM_SIEVE_NET = REGISTRATE
            .item("aluminium_sieve_net", ComponentItem::create)
            .lang("Aluminium Sieve Net")
            .register();

    // 不锈钢筛网
    public static final ItemEntry<ComponentItem> STAINLESS_STEEL_SIEVE_NET = REGISTRATE
            .item("stainless_steel_sieve_net", ComponentItem::create)
            .lang("Stainless Steel Sieve Net")
            .register();

    // 钛筛网
    public static final ItemEntry<ComponentItem> TITANIUM_SIEVE_NET = REGISTRATE
            .item("titanium_sieve_net", ComponentItem::create)
            .lang("Titanium Sieve Net")
            .register();

    // 钨钢筛网
    public static final ItemEntry<ComponentItem> TUNGSTEN_STEEL_SIEVE_NET = REGISTRATE
            .item("tungsten_steel_sieve_net", ComponentItem::create)
