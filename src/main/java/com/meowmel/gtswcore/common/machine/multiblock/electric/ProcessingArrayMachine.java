package com.meowmel.gtswcore.common.machine.multiblock.electric;
...
import com.meowmel.gtswcore.common.data.GTSWRecipeModifiers;
...
import static com.meowmel.gtswcore.common.data.GTSWRecipeModifiers.fastNonPerfectOcSubsecondParallel;
    ...
    public static ModifierFunction recipeModifier(@NotNull MetaMachine machine,
        ...
        if (machine instanceof ProcessingArrayMachine processingArray &&
            ...
            if (realEUt.isInput()) {
                ...
                parallels = GTSWRecipeModifiers.getParallelAmountFast(processingArray, recipe, parallels);
            } else {
                isGenerator = true;
