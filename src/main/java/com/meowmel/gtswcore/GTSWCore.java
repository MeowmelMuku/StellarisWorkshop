...
import com.meowmel.gtswcore.client.renderer.GTSWRenderers;
import com.meowmel.gtswcore.common.data.GTSWCreativeModeTabs;
import com.meowmel.gtswcore.common.data.GTSWItems;
import com.meowmel.gtswcore.common.data.GTSWMachines;
import com.meowmel.gtswcore.common.data.GTSWRecipeTypes;
import com.meowmel.gtswcore.common.vanilla.ItemProperties;
...
@Mod(GTSWCore.MOD_ID)
public class GTSWCore {

    static {
        REGISTRATE.creativeModeTab(() -> GTSWCreativeModeTabs.GTSW);
    }

    public static final String MOD_ID = "gtsw";
    ...
    private void addMaterialRegistries(MaterialRegistryEvent event) {
        GTCEuAPI.materialManager.createRegistry(GTSWCore.MOD_ID);
    }
