...
import static com.meowmel.gtswcore.common.data.GTSWMachines.*;
import static com.meowmel.gtswcore.common.data.GTSWMultiMachines.*;
import static com.meowmel.gtswcore.common.data.GTSWRecipeTypes.*;
...
public class MiscRecipeLoader {
    ...
    private static void createSieveWrapRecipes(Consumer<FinishedRecipe> provider) {
        VanillaRecipeHelper.addShapedRecipe(provider, "steel_sieve_net", STEEL_SIEVE_NET.asStack(),
                "WWW", "WSW", "WWW",
                'W', new MaterialEntry(rod, Steel),
                'S', ITEM_FILTER.asStack());
        VanillaRecipeHelper.addShapedRecipe(provider, "aluminium_sieve_net", ALUMINIUM_SIEVE_NET.asStack(),
                "WWW", "WSW", "WWW",
                'W', new MaterialEntry(rod, Aluminium),
                'S', ITEM_FILTER.asStack());
        VanillaRecipeHelper.addShapedRecipe(provider, "stainless_steel_sieve_net", STAINLESS_STEEL_SIEVE_NET.asStack(),
                "WWW", "WSW", "WWW",
                'W', new MaterialEntry(rod, StainlessSteel),
                'S', ITEM_FILTER.asStack());
        VanillaRecipeHelper.addShapedRecipe(provider, "titanium_sieve_net", TITANIUM_SIEVE_NET.asStack(),
                "WWW", "WSW", "WWW",
                'W', new MaterialEntry(rod, Titanium),
                'S', ITEM_FILTER.asStack());
        VanillaRecipeHelper.addShapedRecipe(provider, "tungsten_steel_sieve_net", TUNGSTEN_STEEL_SIEVE_NET.asStack(),
                "WWW", "WSW", "WWW",
    ...
    private static void createSolarPanelRecipe(Consumer<FinishedRecipe> provider) {
        // solar panel
        VanillaRecipeHelper.addShapedRecipe(provider, "sw_solar_panel_lv", COVER_SOLAR_PANEL_LV.asStack(), "WGW", "CAC",
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, "sw_solar_panel_mv", COVER_SOLAR_PANEL_MV.asStack(), "WGW", "CAC",
                "SPS", 'W', SILICON_WAFER.asStack(), 'G', GTBlocks.CASING_TEMPERED_GLASS.asStack(), 'C',
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, "sw_solar_panel_hv", COVER_SOLAR_PANEL_HV.asStack(), "WGW", "CAC",
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, "sw_solar_panel_uv", COVER_SOLAR_PANEL_UV.asStack(), "WGW", "CAC",
                "SPS", 'W', NEUTRONIUM_WAFER.asStack(), 'G', GTBlocks.FUSION_GLASS.asStack(), 'C',
    ...
    static void createSteamMachineRecipes(Consumer<FinishedRecipe> provider) {
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "steam_alloy_smelter",
                GTSWMultiMachines.STEAM_ALLOY_SMELTER.asStack(),
                "CGC",
                "FMF", "CGC", 'F', new MaterialEntry(rotor, Steel), 'C', GTBlocks.CASING_STEEL_SOLID.asStack(),
                'M', CASING_INDUSTRIAL_STEAM.asStack(), 'G',
    ...
    static void createMultiblockRecipes(Consumer<FinishedRecipe> provider) {
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "mega_blast_furnace", MACRO_BLAST_FURNACE.asStack(),
                "PCP", "FSF", "DWD",
                'A', new MaterialEntry(TagPrefix.spring, GTMaterials.NaquadahAlloy),
                'B', CustomTags.ZPM_CIRCUITS,
                'C', GTItems.FIELD_GENERATOR_ZPM.asStack(),
                'D', GTMultiMachines.ELECTRIC_BLAST_FURNACE.asStack(),
                'E', new MaterialEntry(TagPrefix.plateDense, GTMaterials.Darmstadtium),
                'F', new MaterialEntry(TagPrefix.wireGtHex, GTMaterials.EnrichedNaquadahTriniumEuropiumDuranide));

        VanillaRecipeHelper.addShapedRecipe(provider, "mega_alloy_blast_smelter", MEGA_ALLOY_BLAST_SMELTER.asStack(),
                "ABA", "CDC", "EFE",
                'A', new MaterialEntry(TagPrefix.spring, GTMaterials.NaquadahAlloy),
                'B', CustomTags.ZPM_CIRCUITS,
                'C', GTItems.FIELD_GENERATOR_ZPM.asStack(),
                'D', GCYMMachines.BLAST_ALLOY_SMELTER.asStack(),
                'E', new MaterialEntry(TagPrefix.plateDense, GTMaterials.Darmstadtium),
                'F', new MaterialEntry(TagPrefix.wireGtHex, GTMaterials.EnrichedNaquadahTriniumEuropiumDuranide));

        VanillaRecipeHelper.addShapedRecipe(provider, true, "industrial_pyrolyse_oven",
                INDUSTRIAL_PYROLYSE_OVEN.asStack(),
                "PCP", "FSF", "DWD",
                'C', IV_CIRCUITS,
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "industrial_alloy_blast_smelter",
                INDUSTRIAL_BLAST_ALLOY_SMELTER.asStack(),
                "PCP", "FSF", "DWD",
                'C', IV_CIRCUITS,
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "industry_chemical_reactor",
                INDUSTRY_CHEMICAL_REACTOR.asStack(),
                "PCP", "FSF", "DWD",
                'C', HV_CIRCUITS,
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder("advanced_fusion_reactor_mk3")
                ...
                .stationResearch(b -> b
                        .researchStack(FUSION_REACTOR[UV].asStack())
                        .CWUt(144)
                        .EUt(VA[UHV]))
    ...
    static void createGeneratorRecipes(Consumer<FinishedRecipe> provider) {
        VanillaRecipeHelper.addShapedRecipe(provider, true, "gas_turbine_ev", GTSWMachines.GAS_TURBINE[EV].asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "diesel_generator_ev",
                GTSWMachines.COMBUSTION[EV].asStack(),
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "plasma_turbine_luv",
                GTSWMachines.PLASMA_TURBINE[LuV].asStack(), "PSP", "SAS", "CSC", 'S',
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, true, "plasma_turbine_uv",
                GTSWMachines.PLASMA_TURBINE[UV].asStack(), "PSP", "SAS", "CSC", 'S',
    ...
    private static void createLargeFisherRecipe(Consumer<FinishedRecipe> provider) {
        VanillaRecipeHelper.addShapedRecipe(provider, true, "large_fisher", GTSWMultiMachines.LARGE_FISHER.asStack(),
                "FSF",
