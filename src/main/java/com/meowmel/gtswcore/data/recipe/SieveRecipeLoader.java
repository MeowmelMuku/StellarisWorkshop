...
public class SieveRecipeLoader {
    ...
    private static void createSieveRecipes(Consumer<FinishedRecipe> provider) {
        // 沙砾
        createSieveRecipe(provider, new ItemStack(Blocks.GRAVEL), 1, 1, GTMaterials.Cassiterite, GTMaterials.Coal,
        ...
        createSieveRecipe(provider, new ItemStack(Blocks.SAND), 1, 2, GTMaterials.Almandine, GTMaterials.Amethyst,
                GTMaterials.GreenSapphire, GTMaterials.Opal,
        ...
        createSieveRecipe(provider, new ItemStack(Blocks.DEEPSLATE), 1, 2, GTMaterials.Galena, GTMaterials.Diamond,
                GTMaterials.Graphite, GTMaterials.Copper, GTMaterials.Iron, GTMaterials.Pentlandite,
        ...
        // CRUSHED_BLACKSTONE
        createSieveRecipe(provider, new ItemStack(Blocks.BLACKSTONE), 1, 1, GTMaterials.Cassiterite,
        ...
        createSieveRecipe(provider, new ItemStack(Blocks.BLACKSTONE), 1, 3, GTMaterials.Cobaltite,
                GTMaterials.Garnierite,
                GTMaterials.Nickel, GTMaterials.Pentlandite);

        createSieveRecipe(provider, new ItemStack(Blocks.BLACKSTONE), 1, 4, GTMaterials.GlauconiteSand,
                GTMaterials.Soapstone,
                GTMaterials.Talc, GTMaterials.Grossular, GTMaterials.Pyrolusite);

        // 粉碎地狱岩
        createSieveRecipe(provider, new ItemStack(Blocks.NETHERRACK), 1, 1, GTMaterials.Goethite,
                GTMaterials.YellowLimonite, GTMaterials.Hematite, GTMaterials.Malachite,
    ...
    private static void createSieveRecipe(Consumer<FinishedRecipe> provider, ItemStack input, int tier, int circuit,
                                          Material... materials) {
        int booster = 1;
